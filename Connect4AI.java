...
public class Connect4AI {
    ...
    public int minimax(Connect4Board board, int depth, int maxDepth, boolean isMaximizing) {
         ...
         * int bestScore = -1000;
         * for(int i = 0; i < 7; i++){
         * int curHighScore = minimax(board, depth + 1, maxDepth, false);
         * if(curHighScore > bestScore){
         * bestScore = curHighScore;
         * }
         * }
         * return bestScore;
         * }
         ...
         * for(int i = 0; i < 7; i++){
         * int curLowScore = minimax(board, depth + 1, maxDepth, true);
         * if(curLowScore < lowestScore){
         * lowestScore = curLowScore;
         * }
         * }
         * return lowestScore;
         * }
